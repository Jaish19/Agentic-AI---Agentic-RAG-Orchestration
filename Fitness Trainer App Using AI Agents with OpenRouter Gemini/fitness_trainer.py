# -*- coding: utf-8 -*-
"""Fitness_Trainer_App_Using_AI_Agents_with_OpenRouter_Gemini_2.5

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/153PCHX-GUVEX9oMK_uj81P0d8ppD2ygR
"""

import os
import streamlit as st
from agno.agent import Agent
from agno.models.google import Gemini # Gemini(id="gemini-2.0-flash-exp")
...
dietary_planner = Agent(
    model=OpenRouter(id="google/gemini-2.5-flash-lite"), # Gemini(id="gemini-2.0-flash-exp")
